class DropBoxController {
    ...
    connectFirebase() {
        const config = {
            apiKey: "AIzaSyDSKruMz7t_dqlYWxE77_ES4D5Ld3UU1Sc",
            authDomain: "dropbox-clone-b29bd.firebaseapp.com",
            databaseURL: "https://dropbox-clone-b29bd-default-rtdb.firebaseio.com",
            projectId: "dropbox-clone-b29bd",
            storageBucket: "dropbox-clone-b29bd.appspot.com",
            messagingSenderId: "393254179437"
        };
    ...
    initEvents() {
            ...
            this.removeTask().then(responses => {
                ...
                responses.forEach(response => {
                    if (response.fields.key) {
                        ...
                        //remove do fire base as keys retornadas pelo removeTask
        ...
        this.btnRename.addEventListener('click', e => {
            ...
            if (name) {
                ...
                //.child encontrar o registro por algum parametro
                //.set substituir as informações
        ...
        this.inputFilesEl.addEventListener('change', (event) => {
            ...
            this.uploadTask(event.target.files).then(resposes => {
                resposes.forEach(resp => {
    ...
    uploadTask(files) {
        ...
        //carrega arquivos simultaneos atraves de promessa, array de promessas
        [...files].forEach(file => {
            let formData = new FormData();
    ...
    readFiles() { //verifica quando os valores do fire base muda e busca essa informações
        this.lastFolder = this.currentFolder.join('/');
        //this.getFirebaseRef().on evento do firebase que fica verificando as mudanças no banco
    ...
    openFolder() {
        ...
        //this.getFirebaseRef().off evento do firebase para finalizar as verificações das mudanças no banco
        ...
        li.addEventListener('click', e => {
            ...
            if (e.shiftKey) {
                ...
                if (firstLi) {
                    ...
                    let index = [indexStart, indexEnd].sort(); //ordenar array
